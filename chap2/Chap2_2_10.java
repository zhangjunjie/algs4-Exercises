...
public class Chap2_2_10 {
    ...
    private static void merge(Comparable[] a, Comparable[] aux, int lo, int mid, int hi) {
        ...
        // copy first half to aux[] in increasing order
        for (int k = lo; k <= mid; k++) {
            aux[k] = a[k]; 
        }
        // copy the second half to aux[] in decreasing order
...
//        String[] a = StdIn.readAllStrings();
        ...
        for (int n = N -2; n < N; n++){
          ...
          access_num = 0;
          StdOut.print("n = " + n);
          Chap2_2_10.bu_sort(a, n);
          StdOut.print(" bu an = " + access_num);
          a = sv;
          access_num = 0;
          Chap2_2_10.td_sort(a, n);
